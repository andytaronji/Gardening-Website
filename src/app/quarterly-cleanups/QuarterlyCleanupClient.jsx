  ...
  return (
    <div className="min-h-screen bg-white">
      <div className="container mx-auto px-4 py-16">
        ...
        >
          <h1 className="text-5xl font-playfair text-teal-900 mb-6">Quarterly Cleanup Services</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-20">
          ...
          <motion.div
            ...
            className="space-y-6"
          >
            <h2 className="text-3xl font-playfair text-teal-800">Comprehensive Seasonal Care</h2>
        ...
        >
          <h2 className="text-3xl font-playfair text-teal-800 mb-8 text-center">Seasonal Services</h2>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            >
              ...
              <h3 className="text-xl font-semibold text-teal-800 mb-2">Spring</h3>
            ...
            >
              ...
              <h3 className="text-xl font-semibold text-teal-800 mb-2">Summer</h3>
            ...
            >
              ...
              <h3 className="text-xl font-semibold text-teal-800 mb-2">Fall</h3>
            ...
            >
              ...
              <h3 className="text-xl font-semibold text-teal-800 mb-2">Winter</h3>
        ...
        >
          <div className="bg-teal-50 p-8 rounded-lg shadow-md">
            <h2 className="text-3xl font-semibold text-teal-800 mb-4 text-center">Ready to Schedule Your Cleanup?</h2>
