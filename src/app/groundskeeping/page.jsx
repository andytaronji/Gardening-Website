  ...
  return (
    <div className="min-h-screen bg-white">
      <div className="container mx-auto px-4 py-16">
        ...
        >
          <h1 className="text-5xl font-playfair text-green-900 mb-6">Professional Groundskeeping</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-20">
          ...
          <LazyMotionDiv
            ...
            className="space-y-6"
          >
            <h2 className="text-3xl font-playfair text-green-800">Comprehensive Ground Maintenance</h2>
