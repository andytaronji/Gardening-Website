  ...
  return (
    <div className="min-h-screen bg-white">
      <div className="container mx-auto px-4 py-8">
        {/* Back button */}
        <div className="mb-6">
          <Link href="/blog" className="inline-flex items-center text-teal-600 hover:text-teal-800 transition-colors">
        ...
        <article className="max-w-4xl mx-auto bg-white rounded-lg shadow-lg overflow-hidden">
          ...
          <div className="p-8">
            ...
            {/* Title */}
            <h1 className="text-3xl md:text-4xl font-bold text-teal-800 mb-4">{post.title}</h1>
