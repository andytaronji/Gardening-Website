        ...
        <div className="bg-white rounded-lg shadow-md p-6 mb-6">
          ...
          {results && (
            <div className="mb-8">
              ...
              <div className={`p-4 rounded-md ${results.success ? 'bg-cream border border-sage' : 'bg-red-50 border border-red-200'}`}>
                  ...
                  <details className="mt-2">
                    ...
                    <div className="mt-2 max-h-60 overflow-y-auto">
                      {results.results.map((result, index) => (
                        <div key={index} className={`text-xs p-2 mb-1 rounded ${result.success ? 'bg-cream' : 'bg-red-100'}`}>
