        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <LazyMotionDiv
              ...
              transition={{ duration: 0.6 }}
            >
              <h2 className="text-3xl font-bold text-charcoal mb-6">A Brief History on Grass Lawns</h2>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <LazyMotionDiv
              ...
              transition={{ duration: 0.6 }}
            >
              <h2 className="text-3xl font-bold text-charcoal mb-6">Ground Cover Questionability?</h2>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <LazyMotionDiv
              ...
              transition={{ duration: 0.6 }}
            >
              <h2 className="text-3xl font-bold text-charcoal mb-6">So What is a Groundcover?</h2>
      ...
      <section className="py-16 bg-cream">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            ...
            >
              <h2 className="text-3xl font-bold text-charcoal mb-4">Ground Cover Installation Options</h2>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              >
                ...
                <ul className="space-y-3 text-forest-green">
                  <li className="flex items-start">
                    <span className="text-sage mr-2 font-bold">•</span>
              ...
              >
                ...
                <p className="text-sm text-forest-green/60 italic mb-4">All of the above ground covers including:</p>
                <ul className="space-y-3 text-forest-green">
                  <li className="flex items-start">
                    <span className="text-sage mr-2 font-bold">•</span>
                    <span>Ajuga</span>
