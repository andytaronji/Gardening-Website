      ...
      >
        ...
        <div className="p-6">
          <div className="flex justify-between items-center mb-2">
            ...
            <span className="text-sm text-teal-600">{post.author}</span>
          </div>
          <h3 className="text-xl font-semibold text-teal-700 mb-2">{post.title}</h3>
          ...
          <div className="text-teal-600 hover:text-teal-800 font-semibold inline-flex items-center">
            Read more 
