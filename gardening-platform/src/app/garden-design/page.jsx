...
const jsonLd = {
  ...
  '@type': 'Service',
  'name': 'Professional Garden Design Services',
  'provider': {
    '@type': 'LocalBusiness',
    'name': 'Gardening Thyme',
    'areaServed': ['Marietta', 'Roswell', 'Alpharetta', 'Woodstock', 'Smyrna', 'Vinings']
  },
  'description': 'Comprehensive garden design services including custom landscape design, 2D visualization, and professional implementation. Transform your outdoor space with our expert design process.',
    ...
    'itemListElement': [
      {
        ...
        'itemOffered': {
          ...
          'description': 'Thorough consultation to understand your vision and space requirements'
        }
      },
      {
        '@type': 'Offer',
        'itemOffered': {
          '@type': 'Service',
          'name': 'Custom Design Creation',
          'description': 'Detailed plans blending aesthetics with functionality'
        }
      },
      {
        '@type': 'Offer',
        'itemOffered': {
          ...
          'description': 'Advanced visualization technology to preview your garden design'
        }
      }
    ]
  }
