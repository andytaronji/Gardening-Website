...
const jsonLd = {
  ...
  '@type': 'Service',
  'name': 'Professional Groundskeeping Services',
  'provider': {
    '@type': 'LocalBusiness',
    'name': 'Gardening Thyme',
    'areaServed': ['Marietta', 'Roswell', 'Alpharetta', 'Woodstock', 'Smyrna', 'Vinings']
  },
  'description': 'Comprehensive groundskeeping services including lawn maintenance, seasonal care, and property enhancement. Professional care to maintain your property\'s pristine appearance year-round.',
  'serviceType': 'Groundskeeping',
  'offers': {
    '@type': 'Offer',
    'priceSpecification': {
    ...
    'itemListElement': [
      {
        ...
        'itemOffered': {
          ...
          'description': 'Regular lawn care and maintenance to keep your property healthy and beautiful'
        }
      },
      {
        '@type': 'Offer',
        'itemOffered': {
          '@type': 'Service',
          'name': 'Seasonal Care',
          'description': 'Tailored maintenance programs for different seasons'
        }
      },
      {
        '@type': 'Offer',
        'itemOffered': {
          '@type': 'Service',
          'name': 'Detail-Oriented Care',
          'description': 'Precise edging, pruning, and attention to detail in every aspect of groundskeeping'
        }
      }
    ]
  }
